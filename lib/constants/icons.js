...
export const PIN_ICON_PUBLIC_PATH =
  process.env.NEXT_PUBLIC_PIN_ICON_PATH || "/pin-icons";
export const DEFAULT_PIN_ICON_URL = `${PIN_ICON_PUBLIC_PATH}/${DEFAULT_PIN_ICON_FILE}`;
export const PORTAL_PIN_ICON_URL = `${PIN_ICON_PUBLIC_PATH}/${PORTAL_PIN_ICON_FILE}`;
...
export const DEFAULT_ICONS = DEFAULT_SELECTABLE_PIN_ICON_FILES.map((fileName) => {
  ...
  const iconImageUrl = `${PIN_ICON_PUBLIC_PATH}/${fileName}`;
